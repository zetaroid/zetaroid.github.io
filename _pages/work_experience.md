	...
	<section>
		...
		<div class="content">
			<div class="inner">
				...
				<p>At Bell Flight I am currently supporting the FLRAA program to build the MV-75 (previously known as V-280) tilt-rotor aircraft for the United States Government. I am the data architecture lead for the program. The team I lead leverages the FACE data standard to design all messages sent across the aircraft's digital backbone. Previously, I modeled and wrote C++ for the Air Vehicle Computer. The job is challening but rewarding as I work to meet tight government timelines and milestones.</p>
				<ul class="actions">
